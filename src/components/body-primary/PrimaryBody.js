  ...
  return (
    <>
      ...
      <p className="font-normal mt-1 text-center text-gray-500 text-sm sm:text-lg mx-7">
        With 2.6 million incidents yearly, it's essential to stay safe. Our app is here to help you avoid those sneaky phishing traps. 😊
      </p>
      ...
      <div className="flex max-md:flex-col md:flex-row mt-5">
        ...
        <input type="text" placeholder="Enter website address or URL (eg- www.Google.com)" onChange={(event) => setUrl(event.target.value)}
